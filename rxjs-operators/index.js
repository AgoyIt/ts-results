(function (factory) {
    ...
    function filterResultOk() {
        return function (source) {
            return source.pipe((0, operators_1.filter)(function (result) { return result.ok; }), (0, operators_1.map)(function (result) { return result.val; }));
        };
    }
    exports.filterResultOk = filterResultOk;
    function filterResultErr() {
        return function (source) {
            return source.pipe((0, operators_1.filter)(function (result) { return result.err; }), (0, operators_1.map)(function (result) { return result.val; }));
        };
    }
