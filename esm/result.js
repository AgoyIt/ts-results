...
var ErrImpl = /** @class */ (function () {
    ...
    ErrImpl.prototype.expect = function (msg) {
        throw new Error("".concat(msg, " - Error: ").concat(toString(this.val), "\n").concat(this._stack));
    };
    ErrImpl.prototype.expectErr = function (_msg) {
        return this.val;
    };
    ErrImpl.prototype.unwrap = function () {
        throw new Error("Tried to unwrap Error: ".concat(toString(this.val), "\n").concat(this._stack));
    };
    ...
    ErrImpl.prototype.toString = function () {
        return "Err(".concat(toString(this.val), ")");
    };
...
var OkImpl = /** @class */ (function () {
    ...
    OkImpl.prototype.toString = function () {
        return "Ok(".concat(toString(this.val), ")");
    };
