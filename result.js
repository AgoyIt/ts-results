(function (factory) {
    ...
    var ErrImpl = /** @class */ (function () {
        ...
        ErrImpl.prototype.expect = function (msg) {
            throw new Error("".concat(msg, " - Error: ").concat((0, utils_1.toString)(this.val), "\n").concat(this._stack));
        };
        ErrImpl.prototype.expectErr = function (_msg) {
            return this.val;
        };
        ErrImpl.prototype.unwrap = function () {
            throw new Error("Tried to unwrap Error: ".concat((0, utils_1.toString)(this.val), "\n").concat(this._stack));
        };
        ...
        ErrImpl.prototype.toString = function () {
            return "Err(".concat((0, utils_1.toString)(this.val), ")");
        };
    ...
    var OkImpl = /** @class */ (function () {
        ...
        OkImpl.prototype.toOption = function () {
            return (0, option_1.Some)(this.val);
        };
        /**
        ...
        OkImpl.prototype.toString = function () {
            return "Ok(".concat((0, utils_1.toString)(this.val), ")");
        };
